...
if __name__ == '__main__':
    ...
    if user_1.password == u_pwd:
        ...
        print("User.password is hashed correctly")
    ...
    if user_2.password is not None:
        print("User.password should be None if it is set to None")

    user_2.password = 89
    if user_2.password is not None:
        print("User.password should be None if it is set to an integer")
